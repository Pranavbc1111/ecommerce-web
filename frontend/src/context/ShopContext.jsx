...
const ShopContextProvider=(props)=>{
    ...
    const updateQuantity=async(itemId,size,quantity)=>{
        ...
        if(token){
            try {
                await axios.post("https://ecommerce-backend-three-opal.vercel.app/api/cart/update",{itemId,size,quantity},{headers:{token}})
            } catch (error) {
                console.log(error);
                toast.error(error.message)
    ...
    const getUserCart=async(token)=>{
        try {
            const response=await axios.post("https://ecommerce-backend-three-opal.vercel.app/api/cart/get",{},{headers:{token}})
            if(response.data.success){
